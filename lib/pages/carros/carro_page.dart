...
import 'package:carros_app/pages/carros/mapa_page.dart';
...
class _CarroPageState extends State<CarroPage> {
          ...
          child: Column(
            ...
            children: <Widget>[
              text(widget.carro.nome,
                  fontSize: 20, bold: true, maxLines: 1,overFlow: TextOverflow.ellipsis,),
  ...
  void _onClickMapa() {
    if(carro.latitude != null && carro.longitude != null){
      ...
      alert(context, "Este carro não possui localização");
    }
  }
  ...
  void deletar() async {
    ...
    if (response.ok) {
      alert(context, "Carro deletado com sucesso", callback: () {
        ...
        bus.sendEvent(CarroEvent("delete", carro.tipo));
        pop(context);
      });
    } else {
